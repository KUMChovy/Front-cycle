...
ml-3 mt-1 inline-flex h-[100px] w-[100px] items-center justify-center
    rounded-xl shrink-0
    pointer-events-none select-none
                ...
                "
                    ...
                    <section className="mt-6 grid grid-cols-2 gap-4">
                        <QuickActionCard
                            iconSrc={Designer17}
                            labelLines={["Recomendaciones"]}
                        />
                        <QuickActionCard
                            iconSrc={Designer16}
                            labelLines={["Ejercicios", "recomendados"]}
                        />
                        <QuickActionCard
                            iconSrc={Designer18}
                            labelLines={["Alimentación", "sugerida"]}
                        />
                        <QuickActionCard
                            iconSrc={Designer19}
                            labelLines={["Autocuidado"]}
                        />
                    </section>
                ...
                ring-1 ring-[#f9a8d4]
                shadow-[0_8px_20px_rgba(244,114,182,0.18)]
                px-4 py-3
              "
                            onSubmit={(e) => {
                                e.preventDefault();
...
/** Tarjeta de acción rápida (solo UI, sin imágenes) */
function QuickActionCard({ iconSrc = "", labelLines = [] }) {
    return (
        <button
            type="button"
            className="
        group relative flex h-[128px] flex-col items-center justify-center gap-2
        rounded-2xl
        bg-[radial-gradient(120%_120%_at_20%_20%,rgba(249,168,212,0.55),rgba(252,231,243,0.75)_60%,rgba(255,255,255,0.85))]
        ring-1 ring-[#f9a8d4]/60
        shadow-[0_10px_26px_rgba(244,114,182,0.20)]
        transition
        hover:shadow-[0_14px_34px_rgba(244,114,182,0.28)]
      "
        ...
        >
            ...
            <div className="flex h-[54px] w-[54px] items-center justify-center rounded-xl">
              ...
              bg-white/70 ring-1 ring-pink-200/70
            "
                        aria-hidden
                    />
                )}
